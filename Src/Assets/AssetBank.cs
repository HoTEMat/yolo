    ...
    public class AssetBank {
        ...
        public void LoadContent(ContentManager Content) {
            ...
            Sprites = new SpriteBank {
                ...
                FadedGrafitti = new Sprite { Texture = Textures.Main, SourceRect = new Rectangle(160, 64, 32, 16), Origin = origin16x16, Tone = Color.FromNonPremultiplied(100, 100, 100, 80), },
