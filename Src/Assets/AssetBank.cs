    ...
    public class AssetBank
    {
        ...
        public void LoadContent(ContentManager Content)
        {
            ...
            Tiles = new TileBank
            {
                ...
                // HOUSES
                House1L = new Tile {Sprite = Sprites.House1L},
                House2L = new Tile {Sprite = Sprites.House2L},
                House3L = new Tile {Sprite = Sprites.House3L},
                House4L = new Tile {Sprite = Sprites.House4L},
                House5L = new Tile {Sprite = Sprites.House5L},
                House6L = new Tile {Sprite = Sprites.House6L},
                House7L = new Tile {Sprite = Sprites.House7L},
                House1R = new Tile {Sprite = Sprites.House1R},
                House2R = new Tile {Sprite = Sprites.House2R},
                House3R = new Tile {Sprite = Sprites.House3R},
                House4R = new Tile {Sprite = Sprites.House4R},
                House5R = new Tile {Sprite = Sprites.House5R},
                House6R = new Tile {Sprite = Sprites.House6R},
                House7R = new Tile {Sprite = Sprites.House7R},
                HospitalL = new Tile {Sprite = Sprites.HospitalL},
                HospitalR = new Tile {Sprite = Sprites.HospitalR},
                MarketL = new Tile {Sprite = Sprites.MarketL},
                MarketR = new Tile {Sprite = Sprites.MarketR},
            };
        }
    }
}